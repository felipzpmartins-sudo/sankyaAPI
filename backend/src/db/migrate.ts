...
function migrateTitulosShape(): void {
  ...
  const additions: Array<[string, string]> = [
    ...
    ["VLRJURO", "ALTER TABLE titulos ADD COLUMN VLRJURO REAL NOT NULL DEFAULT 0"],
    ["VLRMULTA", "ALTER TABLE titulos ADD COLUMN VLRMULTA REAL NOT NULL DEFAULT 0"],
    ["VLRDESC", "ALTER TABLE titulos ADD COLUMN VLRDESC REAL NOT NULL DEFAULT 0"],
    ["HISTORICO", "ALTER TABLE titulos ADD COLUMN HISTORICO TEXT"],

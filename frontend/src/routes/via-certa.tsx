...
import { Activity, CalendarDays, GraduationCap } from "lucide-react";
  ...
  return (
    <div className="space-y-5">
      <section className="flex flex-wrap items-end justify-between gap-4">
        ...
        <div className="flex items-center gap-2 rounded-lg border border-border/50 bg-surface px-3 py-2 text-sm text-muted-foreground">
